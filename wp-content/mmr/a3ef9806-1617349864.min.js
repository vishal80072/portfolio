...
buttonStyles();$(this).ajaxComplete(function(){$('style[data-styles="leven-theme-button-css"]').remove().detach();buttonStyles()})});(function($){"use strict";$(document).ready(function($){$(".fw-accordion").accordion({heightStyle:"content"})})})(jQuery);(function($){"use strict";$(document).ready(function($){$(".fw-tabs-container").tabs()})})(jQuery);(function(window,document){'use strict';var supportedBrowser=!1,loaded=!1;if(document.querySelector){if(window.addEventListener){supportedBrowser=!0}}
